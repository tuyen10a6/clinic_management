        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    ...
                    <li class="dropdown chats-dropdown hide-mb-xs"><a href="#" class="dropdown-toggle nk-quick-nav-icon"
                                                                      data-bs-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                            ...
                            <div class="dropdown-body">
                                <ul class="chat-list">
                                    <li class="chat-item"><a class="chat-link" href="/demo2/apps-chats.html">
                                    ...
                                    <li class="chat-item is-unread"><a class="chat-link" href="/demo2/apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    ...
                                                    <div class="status unread"><em class="icon ni ni-bullet-fill"></em>
                                                    </div>
                                                </div>
                                            </div>
                                        </a></li>
                                    <li class="chat-item"><a class="chat-link" href="/demo2/apps-chats.html">
                                            <div class="chat-media user-avatar"><img src="/demo2/images/avatar/b-sm.jpg"
                                                                                     alt=""></div>
                                            <div class="chat-info">
                                                <div class="chat-from">
                                    ...
                                    <li class="chat-item"><a class="chat-link" href="/demo2/apps-chats.html">
                                            <div class="chat-media user-avatar user-avatar-multiple">
                                                <div class="user-avatar"><img src="/demo2/images/avatar/c-sm.jpg"
                                                                              alt=""></div>
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    ...
                                                    <div class="status sent"><em class="icon ni ni-check-circle"></em>
                                                    </div>
                                                </div>
                                            </div>
                                        </a></li>
                                    <li class="chat-item"><a class="chat-link" href="/demo2/apps-chats.html">
                                            <div class="chat-media user-avatar"><img src="/demo2/images/avatar/a-sm.jpg"
                                                                                     alt=""><span
                                                    class="status dot dot-lg dot-success"></span></div>
                                            <div class="chat-info">
                                                <div class="chat-from">
